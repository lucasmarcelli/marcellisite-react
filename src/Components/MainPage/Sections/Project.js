        ...
        <section className="project-top full-height" id="projects">
          <div className="card project-card">
            ...
            <div className="project-jump">
                <button className="btn btn-success" onClick={() => (jump("#active-items", {offset: -40}))}>Active Projects</button>
                <button className="btn btn-info" onClick={() => (jump("#inactive-items", {offset: -40}))}>Inactive Projects</button>
            </div>
          </div>
        </section>
